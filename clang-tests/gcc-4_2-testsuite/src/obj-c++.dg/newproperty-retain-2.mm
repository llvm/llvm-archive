...
/* { dg-options "-Wno-objc-root-class -fobjc-new-property -mmacosx-version-min=10.5" { target powerpc*-*-darwin* i?86*-*-darwin* } } */
/* { dg-options "-Wno-objc-root-class -fobjc-new-property" { target arm*-*-darwin* } } */
