...
- (id)assignObj:(id)obj {
  ...
  SomeObj->contents.s.another = 0; /* { dg-warning "strong-cast assignment has been intercepted" } */
  obj = 0;
  externFunc()->ivar1 = 0; /* { dg-warning "strong-cast assignment has been intercepted" } */
  externFunc()->contents.s.another->SomeObj = 0; /* { dg-warning "strong-cast assignment has been intercepted" } */
  ...
  *indirect = obj; /* { dg-warning "strong\\-cast assignment" } */
  ...
  self = 0;
  self->isa = 0; /* { dg-warning "strong-cast assignment has been intercepted" } */
  return SomeObj = obj; /* { dg-warning "strong-cast assignment has been intercepted" } */
}
@end
...
void function(void) {
	...
	g_myclass->ivar1 = 0; /* { dg-warning "strong-cast assignment has been intercepted" } */
	*g_myclass->ivar1a = 0; /* { dg-warning "strong\\-cast assignment" } */
	l_myclass2 = 0;
	l_myclass2->ivar1 = 0; /* { dg-warning "strong-cast assignment has been intercepted" } */
	...
	g_myclass->ivar3 = 0; /* { dg-warning "strong-cast assignment has been intercepted" } */
	l_myclass->ivar4[1] = 0; /* { dg-warning "strong-cast assignment has been intercepted" } */
        l_myclass->ivar4a = 0; /* { dg-warning "strong-cast assignment has been intercepted" } */
        *l_myclass->ivar4a = 0; /* { dg-warning "strong\\-cast assignment" } */
        (__strong id)*l_myclass->ivar4a = 0; /* { dg-warning "strong\\-cast assignment" } */
	l_myclass->contents.d.data = 0; /* { dg-warning "strong-cast assignment has been intercepted" } */
	...
	l_myclass->contents.s.storage = 0; /* { dg-warning "strong-cast assignment has been intercepted" } */
	l_myclass->contents.s.another->SomeObj = 0; /* { dg-warning "strong-cast assignment has been intercepted" } */
	l_myclass->contents.s.another->storage = 0; /* { dg-warning "strong-cast assignment has been intercepted" } */
	...
	g_myclass1->ivar1 = 0; /* { dg-warning "strong-cast assignment has been intercepted" } */
	g_myclass2->ivar1 = 0; /* { dg-warning "strong-cast assignment has been intercepted" } */
        (*g_myclass2a)->ivar1 = 0; /* { dg-warning "strong-cast assignment has been intercepted" } */
	...
	***g_myid3 = 0; /* { dg-warning "strong\\-cast assignment" } */
	...
	g_myclass2a[1]->ivar1 = 0; /* { dg-warning "strong-cast assignment has been intercepted" } */
	g_myclass2b[1][2]->ivar1 = 0; /* { dg-warning "strong-cast assignment has been intercepted" } */
	g_myclass2c[1]->ivar1 = 0; /* { dg-warning "strong-cast assignment has been intercepted" } */
	g_myclass2d[1][2]->ivar1 = 0; /* { dg-warning "strong-cast assignment has been intercepted" } */
}
