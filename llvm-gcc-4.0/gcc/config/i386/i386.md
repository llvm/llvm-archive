...
(define_constants
  [; Relocation specifiers
   ...
   (UNSPEC_IEEE_MIN             151)     ; not commutative
   (UNSPEC_IEEE_MAX             152)     ; not commutative
...
; APPLE LOCAL begin radar 4645709
...
(define_expand "cmpstrsi"
  ...
  /* x86_64: disable inline expansion for memcmp until 4436760 is fixed */
  ...
  if (GET_CODE (count) == CONST_INT)
      ...
      if (INTVAL (count) == 0)
	{
      ...
      if (!TARGET_MACHO)
        ...
        emit_insn (gen_darwin_cmpstrqi_nz_1 (out, addr1, addr2, countreg, align,
...
(define_expand "darwin_cmpstrqi_nz_1"
  [(parallel [(set (match_operand:SI 0 "register_operand" "")
...
(define_insn "*darwin_cmpstrqi_nz_1"
  [(set (match_operand:SI 0 "register_operand" "=r")
