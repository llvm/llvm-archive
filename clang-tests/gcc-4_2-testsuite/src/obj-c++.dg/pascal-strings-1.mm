...
Str15 hhh = "\p0123456789012345"; /* { dg-error "initializer.string for char array is too long" } */

int foo(void)
{
  Str15 sss = "\p012345678901234";
  Str15 ttt = "\p0123456789012345"; /* { dg-error "initializer.string for char array is too long" } */
