...
;; Note to merger: when the "predicates.md" file is merged in from FSF trunk,
;; it will include this "zero_fp_constant" predicate; please delete this
;; apple-local patch, replacing it with '(include "predicates.md")'.  HTH.
