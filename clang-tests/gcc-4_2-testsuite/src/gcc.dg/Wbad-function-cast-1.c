...
foo(void)
{
  ...
  (_Bool)if3(); /* { dg-warning "cast from function call of type 'long' to non-matching type '_Bool'" } */
  (int)rf1(); /* { dg-warning "cast from function call of type 'float' to non-matching type 'int'" } */
  (long)rf2(); /* { dg-warning "cast from function call of type 'double' to non-matching type 'long'" } */
  (double)cf(); /* { dg-warning "cast from function call of type '_Complex double' to non-matching type 'double'" } */
